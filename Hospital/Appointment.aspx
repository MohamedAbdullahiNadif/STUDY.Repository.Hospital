<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Appointment.aspx.cs" Inherits="Hospital.Appointment" %>
    ...
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           ...
           <div class="form-group">
            <label for="input-6">Time</label>
            <asp:TextBox ID="txttime" CssClass="form-control form-control-rounded" runat="server" textmode="Time"></asp:TextBox>
           </div>
