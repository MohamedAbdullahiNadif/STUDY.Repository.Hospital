<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nurse List.aspx.cs" Inherits="Hospital.Nurse_List" %>
      ...
      <asp:TextBox ID="txtsearch" CssClass="form-control form-control-rounded" placeholder="Search.." name="search"  runat="server" ></asp:TextBox>
        ...
        <hr />
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                       <Columns>
                           <asp:BoundField DataField="Nurse_ID" HeaderText="Nurse_ID" InsertVisible="False" ReadOnly="True" SortExpression="Nurse_ID" />
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT * FROM [Nurse11] WHERE ([Nurse_ID] = @Nurse_ID)">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Nurse_ID" PropertyName="Text" Type="Int32" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
