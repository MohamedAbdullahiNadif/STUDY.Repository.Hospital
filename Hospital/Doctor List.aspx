<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doctor List.aspx.cs" Inherits="Hospital.Doctor_List" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <asp:TextBox ID="txtsearch" CssClass="form-control form-control-rounded" placeholder="Search.." name="search"  runat="server" ></asp:TextBox>
            ...
            <asp:Button ID="btnsarch" class="btn btn-primary" runat="server" Text="search" />
        </div>
        <hr />
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT * FROM [Doctor1] WHERE ([Doctor_ID] = @Doctor_ID)">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Doctor_ID" PropertyName="Text" Type="Int32" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
