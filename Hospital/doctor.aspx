<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="doctor.aspx.cs" Inherits="Hospital.doctor" %>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Doctor Form</div>
           <hr/>
            <form id="form2" runat="server">
           <div class="row" >
           <div class="col-6 form-control-rounded" >
            <label for="input-6">full_name</label>
            <asp:TextBox ID="txtfullname1" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
             <div class="col-6 form-control-rounded">
            <label for="input-6">Qualifications</label>
            <asp:DropDownList ID="ddlQualifications" CssClass="form-control form-control-rounded" runat="server">
                <asp:ListItem>Qualifications_Type</asp:ListItem>
                <asp:ListItem>PHD_Degree</asp:ListItem>
                <asp:ListItem>Masters_Degree</asp:ListItem>
                <asp:ListItem>Bachelor_Degree</asp:ListItem>
                <asp:ListItem>Diploma</asp:ListItem>
               </asp:DropDownList>
           </div>
               </div>
           <div class="form-group">
            <label for="input-7">specialization</label>
          <asp:DropDownList ID="ddlSpecialization_Type" CssClass="form-control form-control-rounded" runat="server">
                ...
                <asp:ListItem>General_Medicine</asp:ListItem>
                <asp:ListItem>General_Surgery</asp:ListItem>
                <asp:ListItem>Dermatologist</asp:ListItem>
                <asp:ListItem>Ophthalmic_Surgery</asp:ListItem>
               </asp:DropDownList>
           </div>
           <div class="row" >
           <div class="col-6 form-control-rounded" >
            <label for="input-8">Phone</label>
             <asp:TextBox ID="txtPhone" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your contact_number"></asp:TextBox>
           </div>
           <div class="col-6 form-control-rounded">
           ...
           <div class="col-4 form-control-rounded">
               ...
               <asp:TextBox ID="txtid" CssClass="form-control form-control-rounded"  runat="server" placeholder="Enter ID:Update or Delet" ></asp:TextBox>
                ...
                <asp:Button ID="btnsubmit" CssClass="btn btn-primary" runat="server" Text="Submit" OnClick="Button1_Click1" />
