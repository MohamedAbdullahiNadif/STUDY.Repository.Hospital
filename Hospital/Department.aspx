<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="Hospital.Department" %>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Department Form</div>
           <hr/>
            <form id="form2" runat="server">
           <div class="form-group">
            <label for="input-6">Dept_Name</label>
            <asp:TextBox ID="txtDept_Name" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your Dept_Name"></asp:TextBox>
           </div>
                ...
                <hr />
                <asp:Button ID="btnSubmit" CssClass="btn btn-primary" runat="server" formnovalidate="" Text="Submit" OnClick="Button1_Click" />
                <asp:Button ID="btnUpdate" CssClass="btn btn-success" runat="server" formnovalidate="" Text="Udate" OnClick="btnUpdate_Click" />
                <asp:Button ID="btndelet" CssClass="btn btn-danger" runat="server" formnovalidate="" Text="Delet" OnClick="btndelet_Click" />
          </form>
         </div>
         </div>
      </div>
