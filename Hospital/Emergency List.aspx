<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emergency List.aspx.cs" Inherits="Hospital.Emergency_List" %>
    ...
    <div class="container-fluid">
      ...
      <asp:TextBox ID="txtsearch" CssClass="form-control form-control-rounded" placeholder="Search.." name="search"  runat="server" ></asp:TextBox>
        ...
        <hr />
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT * FROM [Emergency_Contact] WHERE ([Contact_ID] = @Contact_ID)">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Contact_ID" PropertyName="Text" Type="Int32" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
