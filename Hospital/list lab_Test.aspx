<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list lab_Test.aspx.cs" Inherits="Hospital.list_lab_Test" %>
        ...
        <hr />
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                       <Columns>
                           ...
                           <asp:BoundField DataField="Diagnosis_test" HeaderText="Diagnosis_test" SortExpression="Diagnosis_test" />
                           <asp:BoundField DataField="Age" HeaderText="Age" SortExpression="Age" />
                           <asp:BoundField DataField="Gender" HeaderText="Gender" SortExpression="Gender" />
                       </Columns>
                   </asp:GridView>
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT * FROM [lab] WHERE ([lab_ID] = @lab_ID)">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="lab_ID" PropertyName="Text" Type="Int32" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
