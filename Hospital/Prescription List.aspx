<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prescription List.aspx.cs" Inherits="Hospital.Prescription_List" %>
      ...
      <asp:TextBox ID="txtsearch" CssClass="form-control form-control-rounded" placeholder="Search.." name="search"  runat="server" ></asp:TextBox>
        ...
        <hr />
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                       <Columns>
                           <asp:BoundField DataField="Prescription_Id" HeaderText="Prescription_Id" InsertVisible="False" ReadOnly="True" SortExpression="Prescription_Id" />
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT [Prescription_Id], [Date ] AS Date_, [Dosage] FROM [Prescription1] WHERE ([Prescription_Id] LIKE '%' +@Prescription_Id+ '%')">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Prescription_Id" PropertyName="Text" Type="string" DefaultValue="%" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
