<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nurse.aspx.cs" Inherits="Hospital.Nurse" %>
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Nurse Form</div>
           <hr/>
            <form id="form2" runat="server">
            <div class="row" >
           <div class="col-6 form-control-rounded" >
            <label for="input-6">firs_name</label>
            <asp:TextBox ID="txtfullname" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
            <div class="col-6 form-control-rounded">
            <label for="input-6">last_name</label>
            <asp:TextBox ID="txtlast" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your Last_Name"></asp:TextBox>
           </div>
            </div>
           ...
           <asp:DropDownList ID="ddlGender" CssClass="form-control form-control-rounded" runat="server">
                <asp:ListItem>Gender_Type</asp:ListItem>
 ...
 <hr />
           <div class="">
               <div class="row">
                   <asp:TextBox ID="txtid" CssClass="form-control form-control-rounded" runat="server"></asp:TextBox>
                   <asp:Label ID="lbl" runat="server" BorderStyle="Ridge" ForeColor="#0066FF"></asp:Label>

                   </div>
                   </div>
                <asp:Button ID="btnsubmit" CssClass="btn btn-primary" runat="server" formnovalidate="" Text="Submit" OnClick="btnsubmit_Click" />
