<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientList.aspx.cs" Inherits="Hospital.PatientList" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <asp:TextBox ID="txtsearch" CssClass="form-control form-control-rounded" placeholder="Search.." name="search"  runat="server" ></asp:TextBox>
            ...
            <asp:Button ID="btnsearch" CssClass="btn btn-primary" runat="server" Text="Search" OnClick="Button1_Click1" />
        </div>
        <hr />
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                       <Columns>
                           ...
                           <asp:BoundField DataField="Patient_FName" HeaderText="Patient_FName" SortExpression="Patient_FName" />
                           <asp:BoundField DataField="Patient_LName" HeaderText="Patient_LName" SortExpression="Patient_LName" />
                           ...
                           <asp:BoundField DataField="Condition_" HeaderText="Condition_" SortExpression="Condition_" />
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT * FROM [Patient1] WHERE ([Patient_ID] = @Patient_ID)">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Patient_ID" PropertyName="Text" Type="Int32" DefaultValue="" />
                       </SelectParameters>
                   </asp:SqlDataSource>
