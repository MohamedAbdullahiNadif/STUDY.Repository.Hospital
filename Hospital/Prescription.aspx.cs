...
namespace Hospital
{
    public partial class Prescription : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string sql_query = "insert into Prescription1 values(@Date,@Dosage)";
            SqlCommand cmd = new SqlCommand(sql_query, con);
            cmd.Parameters.AddWithValue("@Date", txtdate.Text);
            cmd.Parameters.AddWithValue("@Dosage", ddlDosage.Text);
            cmd.ExecuteNonQuery();
        ...
        {
            con.Open();
            string edit = "update Prescription1 set  Date=@Date,Dosage=@Dosage where Prescription_Id = '" + txtid.Text + "'";
        ...
        {
            con.Open();
            string del = "delete from Prescription1 where Prescription_Id  ='" + txtid.Text + "'";
