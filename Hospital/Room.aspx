<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Room.aspx.cs" Inherits="Hospital.Room" %>
   ...
   <ul id="theme2" class="sidebar-menu do-nicescrol">
     ...
     <li class="submenu">
      ...
      <li class="submenu">
       ...
       <ul>
       <li><a href="lab.aspx">Add lab_Test</a></li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Room Form</div>
           <hr/>
            <form id="form2" runat="server">
           <div class="form-group">
            <label for="input-6">Room_Number</label>
            <asp:TextBox ID="txtRoom_Number" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your Room_Namber"></asp:TextBox>
           </div>
             <div class="form-group">
            <label for="input-6">Room_type</label>
            <asp:DropDownList ID="ddlroom_typ" CssClass="form-control form-control-rounded" runat="server">
                     <asp:ListItem>Room_Type</asp:ListItem>
                     <asp:ListItem>Single_Room</asp:ListItem>
                     <asp:ListItem>medal_Room</asp:ListItem>
                     <asp:ListItem>Double_Room</asp:ListItem>
                 </asp:DropDownList>
           </div>
           <div class="form-group">
            <label for="input-7">Available</label>
           <asp:DropDownList ID="ddlAvailable" CssClass="form-control form-control-rounded" runat="server">
                     <asp:ListItem>Available</asp:ListItem>
                     <asp:ListItem>Yeas_Availble</asp:ListItem>
                     <asp:ListItem>No_Availble</asp:ListItem>
                 </asp:DropDownList>
           </div>
            <div class="form-group">
            <label for="input-7">Room_Cost</label>
           <asp:DropDownList ID="ddlcost" CssClass="form-control form-control-rounded" runat="server">
