<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staff.aspx.cs" Inherits="Hospital.Staff" %>
      ...
      <div class="col-lg-6">
        <div class="card">
           ...
           <div class="col-6 form-control-rounded" >
            <label for="input-6">Staff_FName</label>
            <asp:TextBox ID="txtStaff_FName" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your doctor_id"></asp:TextBox>
           </div>
           <div class="col-6 form-control-rounded" >
            <label for="input-6">Staff_LName</label>
            <asp:TextBox ID="txtStaff_LName" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
                </div>
                
           <div class="form-group">
            <label for="input-7">Date_Joining</label>
           <asp:TextBox ID="txtDate_Joining" CssClass="form-control form-control-rounded" runat="server" TextMode="Date"> </asp:TextBox>
           </div>
           <div class="form-group">
            <label for="input-8">Specialization_Type</label>
            <asp:DropDownList ID="ddlSpecialization_Type" CssClass="form-control form-control-rounded" runat="server">
                <asp:ListItem>Specialization_Type</asp:ListItem>
                <asp:ListItem>Staff_Dr</asp:ListItem>
                <asp:ListItem>Staff_Nurse</asp:ListItem>
                <asp:ListItem>Staff_Department</asp:ListItem>
               </asp:DropDownList>
           </div>
           <div class="row" >
           <div class="col-6 form-control-rounded" >
            <label for="input-9">Email</label>
            <asp:TextBox ID="txtEmail" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your Email"></asp:TextBox>
           </div>
            <div class="col-6 form-control-rounded" >
            <label for="input-9">Address</label>
                <asp:DropDownList ID="ddlAddress" CssClass="form-control form-control-rounded"  runat="server">
                <asp:ListItem>Address_Type</asp:ListItem>
                <asp:ListItem>Hodan</asp:ListItem>
                <asp:ListItem>Shibis</asp:ListItem>
                <asp:ListItem>Karan</asp:ListItem>
                <asp:ListItem>Shangani</asp:ListItem>
                <asp:ListItem>Dharkenley</asp:ListItem>
                </asp:DropDownList>
           </div>
                </div>
           <hr />
               ...
               <hr />
                <asp:Button ID="btnsumit" CssClass="btn btn-primary" formnovalidate="" runat="server" Text="Submit" OnClick="Button1_Click" />
                <asp:Button ID="btnUdate" CssClass="btn btn-success" formnovalidate="" runat="server" Text="Udate" OnClick="btnUdate_Click" />
                <asp:Button ID="btndate" CssClass="btn btn-danger" formnovalidate="" runat="server" Text="Delet" OnClick="btndate_Click" />
