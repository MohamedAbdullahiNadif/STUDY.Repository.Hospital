<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Medicine.aspx.cs" Inherits="Hospital.Medicine" %>
      ...
      <div class="col-lg-6">
        <div class="card">
           ...
           <div class="form-group">
            <label for="input-6">M_Name</label>
            <asp:TextBox ID="txtM_Name" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your M_Name"></asp:TextBox>
           </div>
           <div class="form-group">
