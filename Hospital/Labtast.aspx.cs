...
namespace Hospital
{
    public partial class Labtast : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string sql_query = "insert into lab values(@Diagnosis_test,@Age,@Gender)";
            SqlCommand cmd = new SqlCommand(sql_query, con);
            cmd.Parameters.AddWithValue("@Diagnosis_test", ddlDiagnosis_test.Text);
        ...
        {
            con.Open();
            string del = "delete from lab where lab_ID ='" + txtid.Text + "'";
        ...
        {
            con.Open();
            string edit = "update lab set Diagnosis_test=@Diagnosis_test,Age=@Age,Gender=@Gender  where lab_ID = '" + txtid.Text + "'";
