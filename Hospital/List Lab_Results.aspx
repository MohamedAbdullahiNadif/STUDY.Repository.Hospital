<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List Lab_Results.aspx.cs" Inherits="Hospital.List_Lab_Results" %>
        ...
        <hr />
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                       <Columns>
                           ...
                           <asp:BoundField DataField="Test_Date" HeaderText="Test_Date" SortExpression="Test_Date" />
                           <asp:BoundField DataField="Result" HeaderText="Result" SortExpression="Result" />
                           <asp:BoundField DataField="Reference_Range" HeaderText="Reference_Range" SortExpression="Reference_Range" />
                           <asp:BoundField DataField="Ordered_By" HeaderText="Ordered_By" SortExpression="Ordered_By" />
                       </Columns>
                   </asp:GridView>
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT [Test_ID], [Test_Date], [Result], [Reference_Range], [Ordered_By] FROM [Lab_Screening1] WHERE ([Test_ID] LIKE '%' + @Test_ID + '%')">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Test_ID" PropertyName="Text" Type="string" DefaultValue="%" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
