<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lab_Screening.aspx.cs" Inherits="Hospital.Lab_Screening" %>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Result_Tast Form</div>
           <hr/>
            <form id="form2" runat="server">
           <div class="form-group">
            <label for="input-6">Test_Date</label>
            <asp:TextBox ID="txtTest_Date" CssClass="form-control form-control-rounded" runat="server" TextMode="Date" ></asp:TextBox>
           </div>
             <div class="form-group">
            <label for="input-6">Result</label>
                 <asp:DropDownList ID="ddlResult" CssClass="form-control form-control-rounded" runat="server">
                     <asp:ListItem>Result_Tast</asp:ListItem>
                     <asp:ListItem>Negative_Test</asp:ListItem>
                     <asp:ListItem>Positive_Test</asp:ListItem>
                 </asp:DropDownList>
           </div>
           <div class="form-group">
            <label for="input-7">Reference_Range</label>
           <asp:DropDownList ID="ddlReference_Range" CssClass="form-control form-control-rounded" runat="server">
                     <asp:ListItem>Result_Tast</asp:ListItem>
                     <asp:ListItem>Normal_Tast</asp:ListItem>
                     <asp:ListItem>High_Test</asp:ListItem>
                 </asp:DropDownList>
           </div>
            <div class="form-group">
            <label for="input-7">Ordered_By</label>
            <asp:DropDownList ID="ddlOrdered_By" CssClass="form-control form-control-rounded" runat="server">
                     <asp:ListItem>Ordered_By_Tast</asp:ListItem>
