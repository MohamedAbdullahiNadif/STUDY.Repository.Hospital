<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prescription.aspx.cs" Inherits="Hospital.Prescription" %>
      ...
      <div class="col-lg-6">
        <div class="card">
           ...
           <div class="form-group">
            ...
            <asp:TextBox ID="txtdate" CssClass="form-control form-control-rounded" runat="server" TextMode="Date" ></asp:TextBox>
           </div>
           <div class="form-group">
            <label for="input-6">Dosage</label>
           <asp:DropDownList ID="ddlDosage" CssClass="form-control form-control-rounded" runat="server">
                     <asp:ListItem>Dosage</asp:ListItem>
                     <asp:ListItem>Three Times</asp:ListItem>
                     <asp:ListItem>After_Breakfast</asp:ListItem>
                     <asp:ListItem>After_lunch</asp:ListItem>
                     <asp:ListItem>After_Dinner</asp:ListItem>
                 </asp:DropDownList>
           </div>
