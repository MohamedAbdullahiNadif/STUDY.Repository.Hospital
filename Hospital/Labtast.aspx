<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Labtast.aspx.cs" Inherits="Hospital.Labtast" %>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Lab_Tast Form</div>
           <hr/>
            <form id="form2" runat="server">
           <div class="form-group">
            <label for="input-6">Diagnosis_test</label>
            <asp:DropDownList ID="ddlDiagnosis_test" CssClass="form-control form-control-rounded" runat="server">
                <asp:ListItem>Diagnosis_Type</asp:ListItem>
                <asp:ListItem>pregnance</asp:ListItem>
            ...
            <asp:TextBox ID="txtAge" CssClass="form-control form-control-rounded" runat="server" TextMode="Date" ></asp:TextBox>
           </div>
           <div class="form-group">
           ...
           <div class="col-4 form-control-rounded">
               ...
               <asp:TextBox ID="txtid" CssClass="form-control form-control-rounded"  runat="server" placeholder="Enter ID:Update or Delet" ></asp:TextBox>
                ...
                <asp:Button ID="btnupdate"  CssClass="btn btn-success" runat="server" Text="Update" OnClick="btnupdate_Click1" />
