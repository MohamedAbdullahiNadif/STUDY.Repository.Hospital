<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Medicine List.aspx.cs" Inherits="Hospital.Medicine_List" %>
        ...
        <hr />
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                       <Columns>
                           ...
                           <asp:BoundField DataField="M_Name_" HeaderText="M_Name_" SortExpression="M_Name_" />
                           <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" />
                       </Columns>
                   </asp:GridView>
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT [Medicine_Id], [M_Name ] AS M_Name_, [Date] FROM [Medicine] WHERE ([Medicine_Id] LIKE '%' + @Medicine_Id + '%')">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Medicine_Id" PropertyName="Text" Type="string" DefaultValue="%" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
