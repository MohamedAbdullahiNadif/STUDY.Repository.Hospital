<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Staff List.aspx.cs" Inherits="Hospital.Staff_List" %>
        ...
        <hr />
             <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                 <Columns>
                     ...
                     <asp:BoundField DataField="Staff_FName" HeaderText="Staff_FName" SortExpression="Staff_FName" />
                     <asp:BoundField DataField="Staff_LName" HeaderText="Staff_LName" SortExpression="Staff_LName" />
                     <asp:BoundField DataField="Date_Joining" HeaderText="Date_Joining" SortExpression="Date_Joining" />
                     <asp:BoundField DataField="Specialization_Type" HeaderText="Specialization_Type" SortExpression="Specialization_Type" />
                     <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" />
                     <asp:BoundField DataField="Address" HeaderText="Address" SortExpression="Address" />
                 </Columns>
                   </asp:GridView>     
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT * FROM [Staff13] WHERE ([staff_ID] = @staff_ID)">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="staff_ID" PropertyName="Text" Type="Int32" DefaultValue="" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
