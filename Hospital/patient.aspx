<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patient.aspx.cs" Inherits="Hospital.patient" %>
   ...
   <ul id="theme2" class="sidebar-menu do-nicescrol">
     ...
     <li class="submenu">
      ...
      <li class="submenu">
       ...
       <ul>
       <li><a href="lab_Test.aspx">Add lab_Test</a></li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Patient Form</div> 
           <hr/>
            <form id="form2" runat="server">
                <div class="row" >
           <div class="col-6 form-control-rounded" >
            <label for="input-10">Patient_FName</label>
            <asp:TextBox ID="txtfname" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
            <div class="col-6 form-control-rounded">
            <label for="input-6">Patient_LName</label>
            <asp:TextBox ID="txtlname" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
            </div>
            <div class="form-group">
            <label for="input-6">Phone</label>
            <asp:TextBox ID="txtphone" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
                <div class="row">
            <div class="col-6 form-contorl-rounded" >
            <label for="input-6">Blood_Type</label>
                <asp:DropDownList ID="ddlblood" CssClass="form-control form-control-rounded" runat="server">
                    <asp:ListItem>Choose Blood_type</asp:ListItem>
            ...
            <asp:TextBox ID="txtemail" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
            </div>
            <div class="form-group">
            <label for="input-6">Gender</label>
                <asp:DropDownList ID="ddlgender" class="form-control form-control-rounded" runat="server">
                ...
                <div class="row">
            <div class="col-6 form-control-rounded">
            <label for="input-6">Condition_</label>
            <asp:TextBox ID="txtcondition" CssClass="form-control form-control-rounded" runat="server" placeholder="Enter Your full_Name"></asp:TextBox>
           </div>
           <div class="col-6 form-control-rounded">
            <label for="input-7">Admission_Date</label>
           <asp:TextBox ID="txtaddate" CssClass="form-control form-control-rounded" runat="server" Textmode="Date"></asp:TextBox>
           </div>
            </div>
            <label for="input-7">Date_Of_Birth</label>
           <asp:TextBox ID="txtdischargedate" CssClass="form-control form-control-rounded" runat="server" Textmode="Date"></asp:TextBox>    
           ...
           <div class="form-group py-2">
               ...
               <hr />
                <asp:Button ID="btnSumit" runat="server" class="btn btn-primary" formnovalidate="" Text="Submit" OnClick="Button1_Click1" />
                <asp:Button ID="btnUpdate" runat="server" CssClass="btn btn-success" formnovalidate="" Text="Update" OnClick="btnUpdate_Click" />
                <asp:Button ID="btnDelet" runat="server" CssClass="btn btn-danger" Text="Delet" OnClick="btnDelet_Click" />
