<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Appointment List.aspx.cs" Inherits="Hospital.Appointment_List" %>
      ...
      <asp:TextBox ID="txtsearch" CssClass="form-control form-control-rounded" placeholder="Search.." name="search"  runat="server" ></asp:TextBox>
        ...
        <hr />
                   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                       <Columns>
                           <asp:BoundField DataField="Appt_Id" HeaderText="Appt_Id" InsertVisible="False" ReadOnly="True" SortExpression="Appt_Id" />
                           <asp:BoundField DataField="Date_" HeaderText="Date_" SortExpression="Date_" />
                           <asp:BoundField DataField="Time" HeaderText="Time" SortExpression="Time" />
                       </Columns>
                   </asp:GridView>
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMSConnectionString %>" SelectCommand="SELECT [Appt_Id], [Date ] AS Date_, [Time] FROM [Appointment] WHERE ([Appt_Id] LIKE '%' + @Appt_Id + '%')">
                       <SelectParameters>
                           <asp:ControlParameter ControlID="txtsearch" Name="Appt_Id" PropertyName="Text" Type="string" DefaultValue="%" />
                       </SelectParameters>
                   </asp:SqlDataSource>
               </form>
